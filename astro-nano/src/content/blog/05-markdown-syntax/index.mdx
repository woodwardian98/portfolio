...
import spongebobImg from './spongebob.webp';
import patrickImg from '../../../assets/patrick.webp';
...
<Image src={spongebobImg} alt="Square Pants" />
...
<Image src={patrickImg} alt="Patrick Starfish" />
